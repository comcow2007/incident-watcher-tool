...
namespace ACTFBIncidentSource
{
    ...
    {
        public const string ID_PREFIX = "PACTFB";
    }

    public class ACTFBIncidentSource : IIncidentSource
    {
        IIncidentWatcher mIncidentWatcher;
        IWatchList mWatchList;
        ACTFBIncidentSourceOptions mOptions;
        ACTFBIncidentItemList mIncidentList;
        ...
        public IWatchNotification GetWatchWindow(string ID, IWatchList Watches)
        {
            ...
            return new ACTFBWatchNotification(mIncidentList.GetIncidentDictionary()[ActualID], Watches, mOptions, this);
        ...
        internal ACTFBIncidentSourceOptions GetOptions()
        {
            return mOptions;
        }
