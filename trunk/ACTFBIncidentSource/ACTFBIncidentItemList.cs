...
{
    class ACTFBIncidentItemList
    {
        private Dictionary<string, ACTFBIncidentItem> mIncidents;
        ...
        public List<GenericIncidentItem> GetIncidents()
        {
            ...
            foreach (KeyValuePair<string, ACTFBIncidentItem> inci in mIncidents)
            {
        ...
        public Dictionary<string, ACTFBIncidentItem> GetIncidentDictionary()
        {
            return mIncidents;
        }
